...
src/
  ...
  game/         Framework-independent game state and rules.
...
- `game/levels` contains static level definitions consumed to create a board.
- `game/unit` contains `Unit`; subclasses belong below it, such as `unit/player/Player`.
...
- Keep `game/` independent from Three.js, DOM APIs, textures, and browser globals.
